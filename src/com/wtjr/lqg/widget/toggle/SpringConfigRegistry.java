...
public class SpringConfigRegistry {
	 ...
	 * 
	 * @param springConfig
	 *            SpringConfig to add to the registry
	 * @param configName
	 *            name to give the SpringConfig in the registry
	 * @return true if the SpringConfig was added, false if a config with that
	 ...
	 * @return true if the SpringConfig was removed, false if it was not
	 *         present.
	 */
