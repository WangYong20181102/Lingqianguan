...
package com.wtjr.lqg.widget.periscope;
...
public class PeriscopeLayout extends RelativeLayout {
	...
	private void init() {
		...
		Drawable red = getResources().getDrawable(R.drawable.wave_circle_unit);
		Drawable yellow = getResources().getDrawable(R.drawable.wave_circle_unit1);
		Drawable blue = getResources().getDrawable(R.drawable.wave_circle_unit2);
...
//	}
	 ...
	 * @param target
	 */
	private void setScale(View target) {
		ObjectAnimator scaleX = ObjectAnimator.ofFloat(target, View.SCALE_X,
				0.2f, 1.5f);
		ObjectAnimator scaleY = ObjectAnimator.ofFloat(target, View.SCALE_Y,
				0.2f, 1.5f);
 ...
 *
 */
	private class BezierListener implements
...
//			target.setAlpha(1f-animatedFraction);
