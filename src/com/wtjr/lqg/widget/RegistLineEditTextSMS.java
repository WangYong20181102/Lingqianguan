 ...
 * @author Myf
 */
public class RegistLineEditTextSMS extends LinearLayout implements OnFocusChangeListener, TextWatcher {
     ...
     * @param attrs
     */
    public RegistLineEditTextSMS(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.widget_regist_line_edit_text_sms, this, true);
