...
public class XCRoundRectImageView extends ImageView{
    ...
    public XCRoundRectImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CornersImageView);
        corners_radius = array.getDimension(R.styleable.CornersImageView_corners_radius, resources.getDimension(R.dimen.d10));
        array.recycle();// 循环再利用
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (null != drawable) {
            ...
            Bitmap b = getRoundBitmap(bitmap, corners_radius);  //圆角弧度
