...
public class UsuallyLayoutHome extends LinearLayout {
    ...
    public UsuallyLayoutHome(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.widget_usually_layout_home, this, true);
