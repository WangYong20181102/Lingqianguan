 ...
 * 
 */
public class UsuallyLayoutItem2 extends RelativeLayout {
	/**
	 * 右侧内容
	 */
	...
	public UsuallyLayoutItem2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void initView(Context context) {
	    ...
	    View view = LayoutInflater.from(context).inflate(R.layout.widget_usually_layout_item2, this, true);
