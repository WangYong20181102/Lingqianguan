...
/**
 * 左侧图片大小为18*18的组合控件，不带背景的通用item控件(为了解决首页和有需要圆角的父布局使用不了圆角的问题)
 *
 * @author dell
 */
public class UsuallyLayoutItem4 extends RelativeLayout {
    /**
     * 右侧内容
     */
    ...
    public UsuallyLayoutItem4(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initView(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.widget_usually_layout_item4, this, true);
