...
public class UsuallyLayoutItem extends RelativeLayout {
    ...
    public UsuallyLayoutItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initView(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.widget_usually_layout_item, this, true);
