...
public class GesturePoint {
	...
	public GesturePoint(int leftX,  int topY,int rightX, int bottomY,
			ImageView image, int num,boolean gesturesTrackColor) {
		super();
	...
	public void setPointState(int state) {
		...
		if (isGesturesTrackColor) {
			...
			case Constants.POINT_STATE_SELECTED:
				this.image.setBackgroundResource(R.drawable.login_logo);
				break;
