 ...
 *
 */
public class BandBankActivity extends BaseActivity implements OnClickListener,HttpRequesListener{
	/**
	 * 标题名字
	 */
	...
	public void findViewById() {
		...
		// 开户名字
		bbeOwner = (BandBankEdit) findViewById(R.id.bbe_owner);
		bbeOwnerEditText = (ClearEditText) bbeOwner.findViewById(R.id.edt_right);

		// 身份证号
		bbeCertNo = (BandBankEdit) findViewById(R.id.bbe_cert_no);
		bbeCertNoEditText = (ClearEditText) bbeCertNo.findViewById(R.id.edt_right);
		...
		// 立即绑定
		btnBbankImmediately = (Button) findViewById(R.id.btn_bbank_immediately);
...
//		bbOpenAccountBranch.setTextRight("建设银行");
	...
	public void setTitle() {
		...
		// 设置名字为:绑定银行卡
		tvTitleName.setText(R.string.band_bank_name);
	}
	...
	private void setPromptDialog(String str1) {
		DialogUtil.promptDialog(BandBankActivity.this, DialogUtil.HEAD_REGISTER,str1, null);
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_select_address:// 开户省市
			intent = new Intent(BandBankActivity.this,SelectBankAddressActivity.class);
            intent.putExtra(BandBankType.class.getName(),BandBankType.noBandBank);
		...
		case R.id.btn_local_phone:// 点击按钮获取本地号码
			...
			break;
		case R.id.btn_bbank_immediately:// 立即绑定
	...
	public void sendHttpRequest(RefreshType type) {
		...
		//开户姓名
		 mOwner = bbeOwner.getTextRight();
		//身份证号
		 mCertNo = bbeCertNo.getTextRight();
		//预留手机号
		...
		if (TextUtils.isEmpty(mCertNo)) {
			setPromptDialog("请输入身份证号");
			return;
		}
	...
	public void goActivity() {
		//跳转到短信验证
		Intent intent=new Intent(BandBankActivity.this, BandBankVerificationCodeActivity.class);
		// 用户唯一标识
		...
		//身份证
		intent.putExtra("cert_no", mCertNo);
		//预留手机号码
