...
public class BalanceDetailsExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    // -----------------------------------------------------------------
    private List<BalanceDetailsTime> balanceDetailsTimes;
    private PullableExpandableListView expandableListView;
    private Resources resources;

    public BalanceDetailsExpandableListAdapter(Context context, List<BalanceDetailsTime> balanceDetailsTimes,
	    PullableExpandableListView expandableListView) {
	this.context = context;
	this.balanceDetailsTimes = balanceDetailsTimes;
	...
	return balanceDetailsTimes.size();
    }
	...
	return balanceDetailsTimes.get(groupPosition);
    }
	...
	return balanceDetailsTimes.get(groupPosition).getListSize();
    }
	...
	return balanceDetailsTimes.get(groupPosition).getContactItemByIndex(childPosition);
    }
	...
	BalanceDetailsTime balanceDetailsTime = (BalanceDetailsTime) getGroup(groupPosition);
	// 为视图对象指定布局
	...
	group_title.setText(balanceDetailsTime.getTime());
	return convertView;
    }
	...
	BalanceDetails balanceDetails = (BalanceDetails) getChild(groupPosition, childPosition);
	...
	// if(lqbDetails.lqbUserunid == null ||
	// lqbDetails.lqbUserunid.equals("null")){
	...
	holder.child_type.setText(balanceDetails.explain);

	setMoneyUpandDown(holder.child_money, balanceDetails.capital);

	holder.child_time.setText(TimeUtil.getFullTime(balanceDetails.detailOptTime, "MM-dd HH:mm"));
	return convertView;
    }
