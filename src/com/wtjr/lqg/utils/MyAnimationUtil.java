	...
	private static Animation createAnimationFromXml(Context c,
		...
		while (((type = parser.next()) != XmlPullParser.END_TAG || parser
			...
			if (name.equals("set")) {
				...
				/**
				 * 如果是alpha标签 则创建AlphaAnimation动画集合 参数 c :context 参数attrs:
				 * 属性集代表duration、 startOffset等属性
				 */
			} else if (name.equals("alpha")) {
				anim = new AlphaAnimation(c, attrs);
				/**
				 * 如果是scale标签 则创建ScaleAnimation动画集合 参数 c :context 参数attrs:
				 * 属性集代表duration、 startOffset等属性
				 */
				...
				/**
				 * 如果是rotate标签 则创建RotateAnimation动画集合 参数 c :context 参数attrs:
				 * 属性集代表duration、 startOffset等属性
				 */
			} else if (name.equals("rotate")) {
				anim = new RotateAnimation(c, attrs);
				/**
				 * 如果是translate标签 则创建TranslateAnimation动画集合 参数 c :context
